...
**Baseline:** 2.33.5  
**Current milestone:** 2.34.0 — Historical SPC Outlook Foundation
...
### 2.34.1 — SPC outlook acquisition

- Add resumable archive download, product manifests, checksums, duplicate detection, and missing-product reporting.
- Preserve original source files and their issued/valid timestamps.
